...
$paginasPermitidas = [
    ...
    'periodizacion', 'temporadas', 'antropometria', 'representante', 'calendario', 'salir',
    'lesion','categorias','bitacora','usuarios','roles','mantenimiento' ,'cargaBienestar', 'mi_perfil', 'asistencia'
];
