...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-06-2026 a las 01:03:50
...
INSERT INTO `bitacora` (`id_bitacora`, `id_usuario`, `modulo_afectado`, `tipo_operacion`, `id_registro_afectado`, `campo_modificado`, `valor_anterior`, `valor_nuevo`, `ip_origen`, `fecha_operacion`) VALUES
(1, 1, 'Módulo Marcas', 'DELETE', 6, 'estado / motivo', 'Activo', 'Inactivo - Motivo: error de tipeo', '::1', '2026-05-25 01:42:11');
...
(1, 1, 'admin@sistema.com', '::1', 1, '2026-05-20 15:47:29'),
(2, 1, 'admin@sistema.com', '::1', 1, '2026-05-20 21:21:21'),
(3, 1, 'admin@sistema.com', '::1', 1, '2026-05-20 21:24:30'),
(4, 1, 'admin@sistema.com', '::1', 1, '2026-05-22 13:09:09'),
(5, 1, 'admin@sistema.com', '::1', 1, '2026-06-01 18:50:38');
...
(1, '00000000', 'Admin', 'Sistema', 'admin@sistema.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, NULL, 0, NULL, NULL, '2026-05-20 15:43:24', NULL);
