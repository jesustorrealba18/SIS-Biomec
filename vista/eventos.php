            ...
            <main class="flex-grow p-4 sm:p-6 lg:p-8 max-w-[1600px] w-full mx-auto space-y-6">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-[#161430] p-6 rounded-2xl border border-[#252345]">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1">Calendario competitivo, metas por atleta y tiempos de corte.</p>
                    </div>
                ...
                <div class="tarjeta p-5">
                    <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
                        <div class="relative w-full md:w-72">
                            ...
                            <input type="text" id="busquedaEvento" onkeyup="filtrarTablaEventos()" placeholder="Buscar por nombre o sede..." class="w-full input-dark pl-11 pr-4 py-3 rounded-xl text-sm">
                        </div>

                        <div class="flex flex-wrap items-center gap-3 w-full md:w-auto justify-end">
                            <select id="filtroTipo" onchange="cargarTablaEventos()" class="input-dark p-3 rounded-xl text-sm bg-[#0f0d23] cursor-pointer">
                            ...
                            <select id="filtroEstado" onchange="cargarTablaEventos()" class="input-dark p-3 rounded-xl text-sm bg-[#0f0d23] cursor-pointer">
