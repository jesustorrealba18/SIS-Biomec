<?php
$tituloPagina = 'Gestión de Drills';
$iconoPagina = 'fa-dumbbell';
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <select name="estilo" id="estilo" class="input-dark w-full p-3 rounded-xl">
                                    <option value="Libre">Libre</option><option value="Espalda">Espalda</option><option value="Braza">Braza</option><option value="Mariposa">Mariposa</option><option value="Combinado">Combinado</option><option value="Multi">Multi</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <select name="categoria" id="categoria" class="input-dark w-full p-3 rounded-xl">
                                <option value="Tecnico">Técnico</option><option value="Fuerza">Fuerza</option><option value="Velocidad">Velocidad</option><option value="Coordinacion">Coordinación</option><option value="Resistencia">Resistencia</option>
                            </select>
                        </div>
           ...
           class="input-dark w-full p-3 rounded-xl text-sm text-gray-300 choice-dark">
                        ...
                        <div class="space-y-1">
                            ...
                            <select name="material_requerido" id="material_requerido" class="input-dark w-full p-3 rounded-xl">
                                <option value="Ninguno">Ninguno</option><option value="Pullboy">Pullboy</option><option value="Aletas">Aletas</option><option value="Tabla">Tabla</option><option value="Paddle">Paddle</option><option value="Resistente">Resistente</option><option value="Pullboy_Aletas">Pullboy y Aletas</option><option value="Multiple">Múltiple</option>
                            </select>
                        </div>
                    </div>
                </div>
