...
-- 
-- Estrategia:
--   - Tablas compartidas: estructura de Jesus (columnas extra
--     estado/motivo_eliminacion en marcas, estado en representantes)
--   - Tablas nuevas de Vero: entrenador, grupo_entrenador
--   - Tablas hibridas: grupos_entrenamiento y sesiones mantienen
--     AMBAS columnas (id_usuario + id_entrenador) para convivir
--     temporalmente sin romper modulos existentes
--   - Datos: se mantienen los de Jesus; los de Vero son datos de
--     prueba y no se incluyen para evitar conflictos de IDs
-- ============================================================
...
--
-- Estructura de tabla para la tabla `entrenador` (NUEVA - de Vero)
-- Tabla independiente para datos especificos del entrenador.
-- id_usuario enlaza con sis_seguridad (opcional).
--
...
--
-- Estructura de tabla para la tabla `grupos_entrenamiento` (HIBRIDA)
...
--
-- Estructura de tabla para la tabla `grupo_entrenador` (NUEVA - de Vero)
...
-- Incluye columnas extra de Jesus: estado y motivo_eliminacion
--
...
-- Incluye columna estado de Jesus
--
...
--
-- Estructura de tabla para la tabla `sesiones` (HIBRIDA)
-- Mantiene AMBAS columnas para compatibilidad temporal:
...
ALTER TABLE `carriles`
  MODIFY `id_carril` int(11) NOT NULL AUTO_INCREMENT;
